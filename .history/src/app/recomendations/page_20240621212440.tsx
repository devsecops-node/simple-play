...
const page = () => {
  ...
  const recom: RecomendationUI2[] = [
    ...
    { id: 3, imagen: '/semaforo.jpg', recomenda: 'Si en algun moomento tienes ganas de llorar, puedes llamarte, no prometo hacerte reir, pero puedo llorar contigo 🥹' },
  ...
  return (
    <Container>
      ...
      {(count % 3 === 0 && count > 0) ? <Image src="/entusiasmo.webbp" alt='entusiasmo cargando' width={100} height={100} />:null}
      <button
