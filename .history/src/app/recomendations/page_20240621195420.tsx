...
const page = () => {
  ...
  return (
    <Container>
      ...
      <p className={`self-center z-10 transition-all duration-150 tracking-tighter text-[15px] font-bold  ${(count % 3 === 0 && count > 0) ? 'block' : 'hidden'}`}>No se puede cargar mas si no haces click</p>
      <button
